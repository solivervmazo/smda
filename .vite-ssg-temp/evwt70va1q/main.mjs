...
import { useSSRContext, mergeProps, resolveComponent, withCtx, createTextVNode, openBlock, createBlock, createVNode, toDisplayString, createCommentVNode } from "vue";
...
const AppHeader_vue_vue_type_style_index_0_scoped_a8cff0c4_lang = "";
const _sfc_main$9 = {
  components: {
    ThemeSwitcher,
    AppHeaderLinks,
...
function _sfc_ssrRender$9(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))} data-v-a8cff0c4><div class="z-10 max-w-screen-lg mx-auto sm:flex justify-between sm:items-center my-3" data-v-a8cff0c4><div class="flex justify-between items-center px-4 sm:px-0" data-v-a8cff0c4><div data-v-a8cff0c4>`);
  _push(ssrRenderComponent(_component_router_link, { to: "/" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        if ($data.theme === "light") {
          _push2(`<img${ssrRenderAttr("src", $data.logoDark)} class="w-36" alt="Dark Logo" data-v-a8cff0c4${_scopeId}>`);
        } else {
          _push2(`<img${ssrRenderAttr("src", $data.logoLight)} class="w-36" alt="Light Logo" data-v-a8cff0c4${_scopeId}>`);
        }
      } else {
        return [
  ...
  _push(`<div class="hidden sm:flex justify-between items-center flex-col md:flex-row" data-v-a8cff0c4>`);
...
const AppHeader = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$9], ["__scopeId", "data-v-a8cff0c4"]]);
const _sfc_main$8 = {
  data: () => {
    return {
      copyrightDate: "2023",
...
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_router_view, { theme: _ctx.appTheme }, null, _parent));
  _push(`</div>`);
  _push(ssrRenderComponent(_component_back_to_top, {
    visibleoffset: "500",
    right: "30px",
    bottom: "20px",
    class: "shadow-lg"
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<i data-feather="chevron-up"${_scopeId}></i>`);
      } else {
        return [
          createVNode("i", { "data-feather": "chevron-up" })
        ];
      }
    }),
    _: 1
...
const router = [
  ...
  },
  {
    ...
    component: () => import(
      /* webpackChunkName: "about" */
      "./assets/Credentials-bfddecf2.js"
    )
  },
  {
    path: "/projects",
  ...
  },
  {
    ...
    component: () => import(
      /* webpackChunkName: "projects" */
      "./assets/SingleProject-153a7ed7.js"
    )
  },
  {
    path: "/contact",
...
const createApp = ViteSSG(
  ...
  ({ app: app2, router: router2, initialState }) => {
    app2.use(router2).use(BackToTop).component("font-awesome-icon", FontAwesomeIcon).provide("imgProjectErrorUrl", new URL(`../src/assets/images/placeholder-project.jpg`, import.meta.url).href).provide("linkClass", "text-indigo-600 dark:text-indigo-300");
