...
const AppHeader_vue_vue_type_style_index_0_scoped_79721cfc_lang = "";
const _sfc_main$9 = {
  components: {
    ThemeSwitcher,
    AppHeaderLinks,
...
function _sfc_ssrRender$9(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))} data-v-79721cfc><div class="z-10 max-w-screen-lg mx-auto sm:flex justify-between sm:items-center my-3" data-v-79721cfc><div class="flex justify-between items-center px-4 sm:px-0" data-v-79721cfc><div data-v-79721cfc>`);
  _push(ssrRenderComponent(_component_router_link, { to: "/" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        if ($data.theme === "light") {
          _push2(`<img${ssrRenderAttr("src", $data.logoDark)} class="w-36" alt="Dark Logo" data-v-79721cfc${_scopeId}>`);
        } else {
          _push2(`<img${ssrRenderAttr("src", $data.logoLight)} class="w-36" alt="Light Logo" data-v-79721cfc${_scopeId}>`);
        }
      } else {
        return [
  ...
  _push(`<div class="hidden sm:flex justify-between items-center flex-col md:flex-row" data-v-79721cfc>`);
...
const AppHeader = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$9], ["__scopeId", "data-v-79721cfc"]]);
const _sfc_main$8 = {
  data: () => {
    return {
      copyrightDate: "2023",
...
const _sfc_main$6 = {
  ...
  data: () => {
    return {
      appTheme: typeof window != "undefined" ? localStorage.getItem("theme") : "light"
    };
  },
  mounted() {
    feather.replace();
